...
function Home() {
  return (
    <div>
      <div
        style={{
          backgroundColor: '#00b7e9',
          height: '350%',
          backgroundImage: 'linear-gradient(160deg, #00b7e9 0%, #80cdd0 100%)',
        }}
      >
        <nav
          className="flex items-center justify-between flex-wrap bg-white-500 shadow p-6"
          id="Home"
        >
        ...
        >
          ...
          >
            ...
            <p style={{ padding: '10%', paddingTop: '40px' }}>
              text to be entered related to the category along with some padding
              and some text in the middle with center justification
            </p>
            <button style={{ border: 'solid black 1px', borderRadius: '4px' }}>
              <a
                href="PharmacySignin"
                className="hover:text-blue-600 "
                style={{ margin: '40px', paddingTop: '40px' }}
              >
                Sign In
              </a>
            </button>
        ...
        <div id="About" style={{ padding: '5%' }}>
          ...
          >
            ...
            <div style={{ padding: '8%' }}>
              <p style={{ color: 'white' }}>
                This is about us what we do how we formed and what is our
                purpose and what is our goal
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div>
            <p style={{ textAlign: 'center', paddingTop: '17%' }}>
              Text related to the services with animation person returning back
              to the pharmacy
            </p>
          </div>
        </div>
