...
function PharmacySignup(){
    ...
    return (
        ...
        <div style={{
          ...
          {
             <fieldset style={{backgroundColor: '#eeeeee', padding: '3em',paddingTop:'3%',
             borderRadius: '10px',
             boxshadow: '0 0 15px #000',}}>
             <div className="signup" >
               <p style={{textAlign:'center', fontSize:'180%',fontFamily:'sans-serif'}}>Sign up</p>
               <br></br>
               <form>
               
   <form>
        <div class="mb-6">
               <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pharmacy name</label>
               <input type="text" id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Pharmacy Name" required></input>
           </div>
        <div class="mb-6">
